    ...
    public class ConstDataFiller : IDataFiller
    {
        public void Fill(DataContext context)
        {
            ...
            List<Book> books = new List<Book>
            {
                ...
                new Book("Metro 2033", "Dmitrij Gluchowski", Guid.Parse("86167D69-FA4D-42CC-8D08-9972F2F04EF5"))
            };
            ...
            context.Events.Add(new Purchase(context.Clients[0], context.BookExamples[0],
                DateTime.Parse("5/10/2020 21:11:00")));
            context.Events.Add(new Purchase(context.Clients[1], context.BookExamples[7],
                DateTime.Parse("3/5/2019 11:30:00")));
            context.Events.Add(new Purchase(context.Clients[0], context.BookExamples[0],
                DateTime.Parse("11/1/2011 11:59:00")));
        }
    }
}